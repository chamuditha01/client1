...
const SocialIcons = () => {
  return (
    <div style={{ position: 'fixed', top: '50%', right: '10px', transform: 'translateY(-50%)', zIndex: 1000 }}>
      ...
      <div style={{ marginBottom: '10px', backgroundColor:'#0de2f1' , padding:'2px',borderRadius:'2px' }}>
      <a id="s1" href="https://www.linkedin.com/in/mohamed-fahadh-360b25142?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><IoLogoLinkedin size={30} color='black' /></a>
    </div>
    </div>
  );
};
